...
func TestEnrichSkipsNonOfficialReleaseYearFallback(t *testing.T) {
	...
	require.NoError(t, err)
	require.NotNil(t, result)
	assert.Equal(t, "rel-2", result.AlbumMBID, "bootleg skipped, unset-status release picked")
