...
export default function DiscoverSearchPage() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    setError(null);
    const p: Promise<SearchResponse> =
      type === "track"
  ...
  return (
    <div className="px-6 pb-24">
      ...
      {!q && <p className="text-zinc-500 text-center py-24">{t("discover.searchHint")}</p>}
      ...
      {q && !error && !loading && type === "track" && <PlatformTrackList tracks={tracks} header />}
