...
import { Play, Clock, Disc3, CheckSquare, Plus, ListPlus, Heart } from "lucide-react"
  ...
  return (
    <div className="p-6 space-y-6 pb-24">
      <div className="flex gap-6">
        <div className="w-48 h-48 rounded-xl bg-zinc-800 flex-shrink-0 flex items-center justify-center">
