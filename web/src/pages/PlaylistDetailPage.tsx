        ...
        header={
          <div className="relative flex items-center">
            <div className="flex items-center gap-3 shrink-0">
              <ListMusic
                className={`w-8 h-8 ${id && player.currentPlaylistId === id ? "text-green-500" : "text-zinc-500"}`}
              />
              <div>
                <h1 className="text-xl font-bold">{playlist.name}</h1>
              </div>
              <span className="text-xs text-zinc-500 self-end pb-0.5">
                {filteredRaw.length} tracks
              </span>
            </div>
