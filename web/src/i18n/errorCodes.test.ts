...
import { ERROR_CODES, getErrorI18nKey, getErrorName, translateApiError } from "./errorCodes";
...
describe("translateApiError", () => {
  ...
  it("code 已知时走 i18n 翻译", () => {
    expect(translateApiError(t, { code: 101, error: "Invalid username or password" })).toBe(
