...
export default function LyricsPanel({ onClose }: Props) {
  ...
  const resizeRef = useRef<{ dir: ResizeDir; startX: number; startY: number; origW: number } | null>(null)
  ...
  return (
    ...
    >
      ...
      <div data-resize-handle className="absolute right-0 top-0 bottom-0 w-1.5 cursor-ew-resize opacity-0 group-hover:opacity-100"
