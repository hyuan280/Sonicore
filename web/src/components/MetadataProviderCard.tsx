    ...
    <Card className="space-y-3">
      ...
      <div className="space-y-3 p-3 rounded-lg bg-zinc-800/50">
        <div className="flex items-center justify-between">
          ...
          <button type="button" role="switch" aria-checked={enabled} aria-label={enableLabel}
        ...
        <div>
          ...
          <Input value={rateLimit} onChange={e => onRateLimitChange(e.target.value)} placeholder="1" disabled={saving} />
        </div>
        ...
        {modified && (
          <div className="flex items-center gap-3">
            ...
            <button type="button" onClick={onRevert} disabled={saving}
